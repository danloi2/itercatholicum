...
const PrayersList: React.FC<PrayersListProps> = ({
  language,
  selectedTimeType,
  prayers,
  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-in fade-in slide-in-from-right-4 duration-500 max-w-4xl mx-auto">
      <div className="text-center mb-8 border-b border-[#c49b9b]/20 pb-6 animate-in fade-in slide-in-from-top-4 duration-700">
        <h1
          className={cn(
            'text-3xl md:text-5xl font-serif font-bold mb-2 tracking-tight',
            selectedTimeType.textClass || 'text-[#3d0c0c]'
          )}
        >
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <span className="text-lg md:text-xl font-serif italic text-[#8B0000]">
            {prayers.filter((p) => p.seasons?.includes(selectedTimeType.id)).length}{' '}
