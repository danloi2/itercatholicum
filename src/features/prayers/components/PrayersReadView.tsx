...
interface PrayersReadViewProps {
  language: 'es' | 'la';
  selectedPrayer: Prayer;
}

export const PrayersReadView: React.FC<PrayersReadViewProps> = ({ language, selectedPrayer }) => {
  return (
      ...
      >
        ...
        >
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-bold font-serif text-[#8b0000] italic">
