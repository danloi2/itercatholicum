...
export const StoleIcon = ({
  ...
  const isWhite =
    color.toLowerCase() === '#ffffff' || color.toLowerCase() === 'white' || color === 'WHITE';
  const crossStroke = isWhite ? '#522b2b' : 'white';
  ...
  return (
    ...
    >
      ...
      {/* Large Central Cross - dynamic color for visibility */}
      <path d="M16 8V32M10 16H22" stroke={crossStroke} strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
};
